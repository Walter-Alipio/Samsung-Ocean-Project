...
- Clone o reposítório e rode no terminal com o comando: npm run dev
...
Nessa segunda etapa tivemos uma breve introdução a banco de dados, entendo algumas das diferenças entre SQL e NoSQL, específicamente o MongoDB.
